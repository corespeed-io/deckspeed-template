...
export interface DeckRendererProps {
  ...
  /** Pointer handlers attached to the canvas layout root. Forwarded to Slide. */
  canvasPointerHandlers?: SlideProps["canvasPointerHandlers"];
  /** Overlay rendered inside the canvas layout root. Forwarded to Slide. */
  canvasOverlay?: SlideProps["canvasOverlay"];
}
