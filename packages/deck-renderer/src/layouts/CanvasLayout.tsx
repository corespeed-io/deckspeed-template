...
export interface CanvasLayoutProps {
  ...
  /** Optional pointer handlers for editor-level canvas interactions such as marquee selection. */
  canvasPointerHandlers?: Pick<
    HTMLAttributes<HTMLDivElement>,
    "onPointerCancel" | "onPointerDown" | "onPointerMove" | "onPointerUp"
  >;
  /** Optional overlay rendered inside the canvas root after canvas nodes. */
